...
arcpy.env.workspace = "C:\Users\98226\Documents\ImperviousProjectArcMap\ReedyPython"
...
arcpy.Merge_management(["imperviousLayers\commercialImpervious.shp", "imperviousLayers\\residentialImpervious.shp", "imperviousLayers\otherImpervious.shp"], output="C:/Users/98226/Documents/ImperviousProjectArcMap/ReedyPython/imperviousLayers/cityImpervious.shp")
print("Merging complete")

print("Clip the city impervious to the watershed.")
arcpy.Clip_analysis(in_features="imperviousLayers\cityImpervious.shp", clip_features="reedyShape\ReedyShape.shp", out_feature_class="C:/Users/98226/Documents/ImperviousProjectArcMap/ReedyPython/imperviousLayers/reedyImpervious.shp", cluster_tolerance="")
...
arcpy.Project_management(in_dataset="initDelin\ReedySubs871_Diss.shp", out_dataset="C:/Users/98226/Documents/ImperviousProjectArcMap/ReedyPython/initDelin/ReedySubs871_DissSPNC.shp", out_coor_system="PROJCS['NAD_1983_StatePlane_North_Carolina_FIPS_3200_Feet',GEOGCS['GCS_North_American_1983',DATUM['D_North_American_1983',SPHEROID['GRS_1980',6378137.0,298.257222101]],PRIMEM['Greenwich',0.0],UNIT['Degree',0.0174532925199433]],PROJECTION['Lambert_Conformal_Conic'],PARAMETER['False_Easting',2000000.002616666],PARAMETER['False_Northing',0.0],PARAMETER['Central_Meridian',-79.0],PARAMETER['Standard_Parallel_1',34.33333333333334],PARAMETER['Standard_Parallel_2',36.16666666666666],PARAMETER['Latitude_Of_Origin',33.75],UNIT['Foot_US',0.3048006096012192]]", transform_method="", in_coor_system="PROJCS['NAD_1983_North_Carolina',GEOGCS['GCS_North_American_1983',DATUM['D_North_American_1983',SPHEROID['GRS_1980',6378137.0,298.257222101]],PRIMEM['Greenwich',0.0],UNIT['Degree',0.0174532925199433]],PROJECTION['Lambert_Conformal_Conic'],PARAMETER['false_easting',2000000.002616667],PARAMETER['false_northing',0.0],PARAMETER['central_meridian',-79.0],PARAMETER['standard_parallel_1',34.33333333333334],PARAMETER['standard_parallel_2',36.16666666666666],PARAMETER['latitude_of_origin',33.75],UNIT['Foot_US',0.3048006096012192]]", preserve_shape="NO_PRESERVE_SHAPE", max_deviation="", vertical="NO_VERTICAL")
print("Project complete")

print("Create geodatabase to place following table (throws error if not in geodatabase)")
arcpy.CreateFileGDB_management("C:/Users/98226/Documents/ImperviousProjectArcMap/ReedyPython", "table.gdb")
print("Geodatabase created")

print("Use tabulate intersection to calculate area and percentage of impervious in each subbasin")
arcpy.TabulateIntersection_analysis(in_zone_features="initDelin\ReedySubs871_DissSPNC.shp", zone_fields="GRIDCODE", in_class_features="imperviousLayers\\reedyImpervious.shp", out_table="C:/Users/98226/Documents/ImperviousProjectArcMap/ReedyPython/table.gdb/reedyICpct2", class_fields="", sum_fields="", xy_tolerance="-1 Unknown", out_units="UNKNOWN")
...
arcpy.TableToTable_conversion("initDelin\ReedySubs871_DissSPNC.shp", "C:/Users/98226/Documents/ImperviousProjectArcMap/ReedyPython", "imperviousReedyTable.csv")
print("Table export complete")

# to be continued -> make it so that the resulting table is ready to be exported to SWMM